...
using ElementC = cutlass::nv_float4_t<cutlass::float_e2m1_t>;
using ElementD = cutlass::nv_float4_t<cutlass::float_e2m1_t>;
...
using CollectiveEpilogue = typename cutlass::epilogue::collective::CollectiveBuilder<
    ...
    ElementC, LayoutCTag, 32,
    ElementD, LayoutDTag, 32,
